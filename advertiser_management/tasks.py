...
def daily_report():
    ...
    for ad in ads:
        ...
        AdsReports.objects.create(count_click=click_count, count_view=view_count, ad=ad, daily=True)
    return 'Done!'
...
def hourly_report():
    ...
    for ad in ads:
        ...
        AdsReports.objects.create(count_click=click_count, count_view=view_count, ad=ad, hourly=True)
    return 'Done!'
